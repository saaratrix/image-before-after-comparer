import { imageTemplateRequestEvent } from './models/events.js';
export class ImagePositionAdjuster {
    ...
    initialize() {
        ...
        document.addEventListener(imageTemplateRequestEvent, (event) => this.onTemplateRequest(event));
        return this.loadingCv;
    }
